# ref from: https://www.bilibili.com/read/cv15847481
...
class Stamp:
    ...
    def draw_rotated_text(self, image, angle, xy, r, word, fill, font_size, font_xratio, stroke_width, font_flip = False, *args, **kwargs):
        ...
        if is_Chinese(word):
            font = ImageFont.truetype("./fonts/simsun.ttc", font_size, encoding="utf-8")
        else:
            font = ImageFont.truetype("./fonts/Arial.ttf", font_size, encoding="utf-8")
